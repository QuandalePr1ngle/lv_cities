...
INSERT INTO cities(title, year, population, region) VALUES ('Ādaži', 2022, 7482, 'Ādažu novads')
...
,('Zilupe', 1931, 1369, 'Ludzas novads');
 ...
 SELECT title, region -- 3 uzd
 FROM cities;
 
 
 
 SELECT * FROM cities -- 4 uzd
 WHERE year < 1924;
 
 
 SELECT * FROM cities -- 5 uzd
 WHERE population <= 3501;
 
 
 SELECT * FROM cities -- 6 uzd 
 ...
 SELECT DISTINCT * FROM cities; -- 8 uzd
 
 

DELETE FROM cities WHERE title = 'Durbe'; -- 9 uzd 
